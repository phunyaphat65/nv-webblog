<template>
  <div>
    <div class="nv-navbar">
      <ul class="nav">
        <li><router-link :to="{ name: 'blogs' }">Movie</router-link></li>
...
.nv-navbar .nav {
  ...
  padding: 0;
  display: flex;
  justify-content: center; /* จัดให้ลิงก์อยู่ตรงกลาง */
}
...
.nv-navbar .nav li:last-child {
  margin-right: 0; /* ไม่มีระยะห่างทางด้านขวาสำหรับลิงก์สุดท้าย */
}
